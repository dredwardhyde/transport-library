...
public class HttpLeaderTest extends AbstractLeaderTestServer {
    ...
    static {
        ...
        System.setProperty("jaffa.rpc.test.server.test.mode", "false");
        System.setProperty("jaffa.rpc.test.server.protocol.http.ssl.server.truststore.location", "src/test/resources/truststore.jks");
        System.setProperty("jaffa.rpc.test.server.protocol.http.ssl.server.truststore.password", "simulator");
        System.setProperty("jaffa.rpc.test.server.protocol.http.ssl.server.keystore.location", "src/test/resources/keystore.jks");
        System.setProperty("jaffa.rpc.test.server.protocol.http.ssl.server.keystore.password", "simulator");
